...
- (void)viewWillAppear:(BOOL)animated {
    ...
    UIButton *zoomInButton= [SLVDecorator roundButtonWithlabel:@"+" image:nil frame:CGRectMake(w, bounds.size.height/2 - 80, 35, 35)];
    [zoomInButton addTarget:self action:@selector(zoomIn:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:zoomInButton];
    UIButton *zoomOutButton= [SLVDecorator roundButtonWithlabel:@"-" image:nil frame:CGRectMake(w, bounds.size.height/2 - 40, 34, 34)];
